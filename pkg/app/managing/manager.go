...
func NewService(cd CategoryDeleter, cc CategoryCreator, cu CategoryUpdater, tc TelegramCommander, rm RuleManager, um UserManager, im InstallmentManager) Service {
	return Service{cd, cc, cu, tc, rm, um, im}
}
